...
//    }
    ...
    /**
     * @param resourceName
     * @return String of the path of the resource
     */
    public static String getPathOfResource(String resourceName) {
        ...
        if (ret.charAt(0) == '/' && ret.charAt(2) == ':' && ret.charAt(3) == '/') return ret.substring(1);
        return ret;
    }

    /**
     * @param resourceName
     * @return String of the contents of the resource
     * @throws IOException
     */
    ...
    public static List arrayToIntegerList(Object[] objs) {
        ...
        List ret = new ArrayList(objs.length);
        for (Object obj : objs) {
            if (!((String)obj).equals("")) ret.add(Integer.valueOf((String)obj));
        }
        return ret;
    }
     ...
     * @param cola
     * @param colb
     * @return boolean indicatinf if the two collections are equal
     */
    ...
    /**
     * @param t
     * @return Stirng of the stacktrace
     */
