...
/**
 * <p>
 * <code>Directory</code> is a helper class to build a MARC directory.
 * </p>
 * <p>
 * The directory is an index to the location of the variable fields within a
 * record. The directory consists of entries. Each directory entry is 12
 * characters in length. The structure of each entry according to the MARC
 ...
 * </p>
 * <p>
 * The starting character position gives the starting position of the variable
 * field to which the entry corresponds relative to the base address of data of
 * the record. A starting character position or length of field of fewer than
 * five digits is right justified and unused positions contain zero's.
 * </p>
 * 
...
public class Directory {
    ...
    /**
     * <p>
     * Adds a new entry to the MARC directory.
     * </p>
     * 
     * @param tag
     *            the tag name
    ...
    /**
     * <p>
     * Returns a <code>String</code> representation for the directory following
     * the structure of the MARC directory.
     * </p>
     * 
