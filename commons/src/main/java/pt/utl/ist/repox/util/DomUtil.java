...
public class DomUtil {
    ...
    public static String domToString(Node doc, boolean withXmlDeclaration) {
        try {
            ...
            if (!withXmlDeclaration) transformer.setOutputProperty(OutputKeys.OMIT_XML_DECLARATION, "yes");
    ...
    private static Transformer getTransformer(String xsltFile) throws TransformerConfigurationException {
        ...
        if (tpl == null) {
            ...
            if (tpl == null) { throw new RuntimeException("Stylesheet does not exist: " + xsltFile); }
