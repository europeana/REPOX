...
/**
 * <p>
 * <code>Leader</code> defines behaviour for the record label (record position
 * 00-23).
 * </p>
 * 
 * <p>
 * The leader is a fixed field that occurs at the beginning of a MARC record and
 * provides information for the processing of the record. The structure of the
 * leader according to the MARC standard is as follows:
 * </p>
 * 
 * <pre>
 ...
 * </pre>
 * <p>
 * This structure is returned by the {@link #getSerializedForm()} method.
 * </p>
 * 
...
public class Leader {
     ...
     *            character representing the number of indicators present in a
     *            data field
     */
     ...
     *            character representing the subfield code length
     */
    ...
    /**
     * <p>
     * Returns a String representation of the record label following the MARC
     * structure.
     * </p>
     * 
    ...
    public String getSerializedForm() {
        return new StringBuffer().append(df.format(recordLength).toString()).append(recordStatus).append(typeOfRecord).append(implDefined1).append(charCodingScheme).append(indicatorCount).append(subfieldCodeLength).append(df.format(baseAddressOfData).toString()).append(implDefined2).append(entryMap).toString();
    }
