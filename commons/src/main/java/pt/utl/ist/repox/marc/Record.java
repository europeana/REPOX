...
import pt.utl.ist.repox.marc.iso2709.ISOHandlerSingleRecord;
import pt.utl.ist.repox.marc.iso2709.MARCPartialReader;
import pt.utl.ist.repox.marc.util.Directory;
import pt.utl.ist.repox.marc.util.Leader;
import pt.utl.ist.repox.marc.xml.DomBuilder;
import pt.utl.ist.repox.marc.xml.MarcXChangeBuilder;
import pt.utl.ist.repox.marc.xml.RecordBuilderFromMarcXml;
...
public class Record implements Serializable, Iterable<Field> {
     ...
     */
    public pt.utl.ist.repox.marc.Field addField(String tag) {
     ...
     * @return the added field
     */
    public pt.utl.ist.repox.marc.Field addField(int tag) {
     ...
     * @return the added field
     */
    public pt.utl.ist.repox.marc.Field addField(short tag) {
