 ...
 */
package pt.utl.ist.repox.marc.xml;
...
public class MarcSaxParserOaiMarc extends DefaultHandler {
    ...
    public void endDocument() throws SAXException {
        if (client != null) client.signalParseFinished();
    }
    ...
    /**
     * @param in
     *            The InputStream with the records in xml
     ...
     *            The InputStream with the records in xml
     * @param client
     *            The class that will process the parsed records
     * @throws SAXException
     */
    ...
    public static void main(final String[] args) {
        try {
            ...
            MarcSaxParserOaiMarc.parse(new FileInputStream("C:\\desktop\\000000001-817185_xserver.xml"), new MarcSaxParserClient() {
                @Override
