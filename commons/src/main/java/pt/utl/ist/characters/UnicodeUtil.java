...
public class UnicodeUtil {
    ...
    /**
     * Value returned in
     * <code><a href="#bounds32(java.lang.String, int)">bounds32()</a></code>.
     */
     ...
     */
    private static final int NON_CHARACTER_BASE = 0xFFFE, NON_CHARACTER_END = 0xFFFF;

    // useful statics and tables for fast lookup

    /**
     * Values for surrogate detection. X is a surrogate iff X & SURROGATE_MASK
     * == SURROGATE_MASK.
     */
    ...
    /**
     * Any codepoint at or greater than SURROGATE_SPACE_BASE requires 2 16-bit
     * code units.
     */
     ...
     */
    private static final int SURROGATE_OFFSET   = MIN_SUPPLEMENTARY - (LEAD_BASE << SURROGATE_SHIFT) - TRAIL_BASE;
    ...
    public static String append32(int char32) {
        ...
        if (char32 >= MIN_SUPPLEMENTARY) {
            return String.valueOf((char)(LEAD_BASE_OFFSET + (char32 >> SURROGATE_SHIFT))) + ((char)(TRAIL_BASE + (char32 & TRAIL_MASK)));
        } else {
