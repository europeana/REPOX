...
/**
 * Convert native "item" to desc. In this case, the native "item" is assumed to
 ...
 */
public class Copydesc extends XSLTCrosswalk {
     ...
     */
    public Copydesc(Properties properties) throws OAIInternalServerError {
        super(properties, "http://errol.oclc.org/oai:xmlregistry.oclc.org:sts/desc http://errol.oclc.org/oai:xmlregistry.oclc.org:sts/desc.xsd", null);
        try {
            String xsltName = properties.getProperty("Copydesc.xsltName");
            if (xsltName != null) {
