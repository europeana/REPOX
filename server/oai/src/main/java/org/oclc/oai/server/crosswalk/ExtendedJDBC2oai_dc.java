...
public class ExtendedJDBC2oai_dc extends Crosswalk {
    ...
    public String createMetadata(Object nativeItem) {
        ...
        if (dcTitleLabel != null && (dcTitle = coreTable.get(dcTitleLabel)) != null) {
            sb.append("<dc:title>");
            sb.append(OAIUtil.xmlEncode(dcTitle.toString()));
            sb.append("</dc:title>");
        }

        if (dcCreatorLabel != null && (dcCreator = coreTable.get(dcCreatorLabel)) != null) {
            sb.append("<dc:creator>");
            sb.append(OAIUtil.xmlEncode(dcCreator.toString()));
            sb.append("</dc:creator>");
        }

        if (dcSubjectLabel != null && (dcSubject = coreTable.get(dcSubjectLabel)) != null) {
            sb.append("<dc:subject>");
            sb.append(OAIUtil.xmlEncode(dcSubject.toString()));
            sb.append("</dc:subject>");
        }

        if (dcDescriptionLabel != null && (dcDescription = coreTable.get(dcDescriptionLabel)) != null) {
            sb.append("<dc:description>");
            sb.append(OAIUtil.xmlEncode(dcDescription.toString()));
            sb.append("</dc:description>");
        }

        if (dcPublisherLabel != null && (dcPublisher = coreTable.get(dcPublisherLabel)) != null) {
            sb.append("<dc:publisher>");
            sb.append(OAIUtil.xmlEncode(dcPublisher.toString()));
            sb.append("</dc:publisher>");
        }

        if (dcContributorLabel != null && (dcContributor = coreTable.get(dcContributorLabel)) != null) {
            sb.append("<dc:contributor>");
            sb.append(OAIUtil.xmlEncode(dcContributor.toString()));
            sb.append("</dc:contributor>");
        }

        if (dcDateLabel != null && (dcDate = coreTable.get(dcDateLabel)) != null) {
            sb.append("<dc:date>");
            sb.append(OAIUtil.xmlEncode(dcDate.toString()));
            sb.append("</dc:date>");
        }

        if (dcTypeLabel != null && (dcType = coreTable.get(dcTypeLabel)) != null) {
            sb.append("<dc:type>");
            sb.append(OAIUtil.xmlEncode(dcType.toString()));
            sb.append("</dc:type>");
        }

        if (dcFormatLabel != null && (dcFormat = coreTable.get(dcFormatLabel)) != null) {
            sb.append("<dc:format>");
            sb.append(OAIUtil.xmlEncode(dcFormat.toString()));
            sb.append("</dc:format>");
        }

        if (dcIdentifierLabel != null && (dcIdentifier = coreTable.get(dcIdentifierLabel)) != null) {
            sb.append("<dc:identifier>");
            sb.append(OAIUtil.xmlEncode(dcIdentifier.toString()));
            sb.append("</dc:identifier>");
        }

        if (dcSourceLabel != null && (dcSource = coreTable.get(dcSourceLabel)) != null) {
            sb.append("<dc:source>");
            sb.append(OAIUtil.xmlEncode(dcSource.toString()));
            sb.append("</dc:source>");
        }

        if (dcLanguageLabel != null && (dcLanguage = coreTable.get(dcLanguageLabel)) != null) {
            sb.append("<dc:language>");
            sb.append(OAIUtil.xmlEncode(dcLanguage.toString()));
            sb.append("</dc:language>");
        }

        if (dcRelationLabel != null && (dcRelation = coreTable.get(dcRelationLabel)) != null) {
            sb.append("<dc:relation>");
            sb.append(OAIUtil.xmlEncode(dcRelation.toString()));
            sb.append("</dc:relation>");
        }

        if (dcCoverageLabel != null && (dcCoverage = coreTable.get(dcCoverageLabel)) != null) {
            sb.append("<dc:coverage>");
            sb.append(OAIUtil.xmlEncode(dcCoverage.toString()));
            sb.append("</dc:coverage>");
        }

        if (dcRightsLabel != null && (dcRights = coreTable.get(dcRightsLabel)) != null) {
            sb.append("<dc:rights>");
