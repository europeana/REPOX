...
public class MappingOptionListContainer extends OptionListContainer {
    ...
    public MappingOptionListContainer(URI baseUri) {
        ...
        optionList.add(new Option("[GET]Retrieve a mapping.", baseUri + MAPPINGS + "/" + MAPPINGIDLITERAL, null));
        optionList.add(new Option("[PUT]Update a mapping.", baseUri + MAPPINGS + "/" + MAPPINGIDLITERAL, null));
        optionList.add(new Option("[DELETE]Delete a mapping.", baseUri + MAPPINGS + "/" + MAPPINGIDLITERAL, null));
