...
public class RepoxStatisticsDefault extends RepoxStatistics {
     ...
     * @param recordsTotal
     */
    public RepoxStatisticsDefault(int dataSourcesIdExtracted, int dataSourcesIdGenerated, int dataSourcesIdProvided, int dataProviders, int dataSourcesOai, int dataSourcesZ3950, int dataSourcesDirectoryImporter, Map<String, MetadataFormatStatistics> dataSourcesMetadataFormats,
