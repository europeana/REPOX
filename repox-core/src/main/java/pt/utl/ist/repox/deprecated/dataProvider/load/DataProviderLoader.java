package pt.utl.ist.repox.deprecated.dataProvider.load;
//package pt.utl.ist.repox.deprecated;
//
...
//
//    /*
//     * TEL EXAMPLE <dataProviders
//     * xmlns="http://repox.ist.utl.pt/schemas/dataProviders"
//     * xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation=
//     * "http://repox.ist.utl.pt/schemas/dataProviders repox_data_providers.xsd "
//     * > <dataProvider id="TEL" name="The European Library" country="-">
//     * <dataSource id="a0078" name=
//     * "Kramerius - 19th and 20th century digitised periodicals and monographs from the Czech Republic"
//     * > <oaiPmhDataSource>
//     * <baseUrl>http://kramerius.nkp.cz/kramerius/oai?metadataPrefix
//     * =oai_dc&amp;</baseUrl> <fullHarvestPeriodicity></fullHarvestPeriodicity>
//     * <IncrementalHarvestPeriodicity></IncrementalHarvestPeriodicity>
//     * </oaiPmhDataSource> <export>
//     * <fileSystemLocation>/solr/collections/a0078</fileSystemLocation>
//     * <periodicity></periodicity> </export> </dataSource>
//     */
//
//    /**
//     * @param dataProvidersFile
...
//
//        if (!dataProvidersFile.exists()) { return dataProviders; }
//
...
//                    } else {
//
//                        dataSource = new DataSourceOai(provider, id, description, "http://www.openarchives.org/OAI/2.0/oai_dc.xsd", "http://www.openarchives.org/OAI/2.0/", "oai_dc", urlString, "", new IdProvided(), null);
//                    }
//
...
//    }
//
//    private DataSourceOai getDataSourceOai(String urlString, DataProvider provider, String id, String description) throws MalformedURLException {
...
//
//        return new DataSourceOai(provider, id, description, "http://www.openarchives.org/OAI/2.0/oai_dc.xsd", "http://www.openarchives.org/OAI/2.0/", metadataFormat, oaiSource, oaiSet, new IdProvided(), null);
//    }
//
//    /**
//     * @param args
