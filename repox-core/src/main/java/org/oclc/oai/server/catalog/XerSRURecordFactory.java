...
public class XerSRURecordFactory extends RecordFactory {
     ...
     */
    public XerSRURecordFactory(Properties properties) throws IllegalArgumentException {
        super(properties);
     ...
     */
    public XerSRURecordFactory(Properties properties, HashMap crosswalkMap) throws IllegalArgumentException {
        super(crosswalkMap);
    }
    ...
    public String getDatestamp(Object nativeItem) throws IllegalArgumentException {
        ...
        try {
            String datetime = XPathAPI.eval(recordData, "/ber/tag0/tag0[@class='private'/tag0]/", xmlnsEl).str();
            return datetime;
