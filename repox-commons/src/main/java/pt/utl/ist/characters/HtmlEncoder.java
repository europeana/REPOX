...
public class HtmlEncoder {
     ...
     * This means that 'getEntity()' is always guaranteed to return a valid
     * string representing 'c'.
     * 
     * @param c
     *            the character to convert.
     * @return a string that contains either an entity representing 'c' or 'c'
     *         itself.
     */
     ...
     * corresponding to 'c' exist, this method returns a string containing 'c'.
     * This means that 'getNumericEntity()' is always guaranteed to return a
     * valid string representing 'c'.
     * 
     * @param c
     *            the character to convert.
    ...
    /**
     * Creates a Writer that, when written to, writes entity equivalents of each
     * character to 'out'; where entity equivalents do not exist, the original
     * character is written directly to 'out'.
     * 
     * @param out
     *            the writer to which to write the output.
     * @return Writer
     */
