...
public class DataManagerDefault implements DataManager {
     ...
     */
    public DataManagerDefault(File dataProvidersFile, MetadataTransformationManager metadataTransformationManager, MetadataSchemaManager metadataSchemaManager, File repositoryPath, File oldTasksFile, RepoxConfigurationDefault configuration) throws DocumentException, IOException, ParseException {
        super();
            ...
            for (Element currentDataProviderElement : (List<Element>)document.getRootElement().elements("provider")) {
                ...
                for (Element currentDataSourceElement : (List<Element>)currentDataProviderElement.elements("source")) {
                    ...
                    if (dataSourceType.equals("DataSourceOai")) {
                        ...
                        dataSource = new DataSourceOai(provider, id, description, schema, namespace, metadataFormat, oaiSource, oaiSet, new IdProvided(), metadataTransformations);
                    } else if (dataSourceType.equals("DataSourceSruRecordUpdate")) {
                        dataSource = new DataSourceSruRecordUpdate(provider, id, description, schema, namespace, metadataFormat, recordIdPolicy, metadataTransformations);
                        ...
                        dataSource = new DataSourceDirectoryImporter(provider, id, description, schema, namespace, metadataFormat, extractStrategy, retrieveStrategy, characterEncoding, sourcesDirPath, recordIdPolicy, metadataTransformations, recordXPath, namespaces);
    ...
    public DataSource createDataSourceSruRecordUpdate(String dataProviderId, String id, String description, String schema, String namespace, String metadataFormat, Map<String, MetadataTransformation> metadataTransformations, List<ExternalRestService> externalRestServices, String marcFormat)
        ...
        if (getDataSourceContainer(id) == null) {
            if (isIdValid(id)) {
                DataProvider dataProvider = getDataProvider(dataProviderId);
                if (dataProvider != null) {
                    DataSource newDataSource = new DataSourceSruRecordUpdate(dataProvider, id, description, schema, namespace, metadataFormat, new IdGenerated(), new TreeMap<String, MetadataTransformation>());
            ...
            if (isIdValid(id)) {
                ...
                if (dataProvider != null) {
                    ...
                    if (recordIdPolicy != null) {
                        ...
                        DataSource newDataSource = new DataSourceDirectoryImporter(dataProvider, id, description, schema, namespace, metadataFormat, extractStrategy, retrieveStrategy, characterEncoding, DataSourceFtp.getOutputFtpPath(server, id), recordIdPolicy, new TreeMap<String, MetadataTransformation>(), recordXPath, namespaces);
            ...
            if (isIdValid(id)) {
                ...
                if (dataProvider != null) {
                    ...
                    if (recordIdPolicy != null) {
                        ...
                        DataSource newDataSource = new DataSourceDirectoryImporter(dataProvider, id, description, schema, namespace, metadataFormat, extractStrategy, retrieveStrategy, characterEncoding, sourcesDirPath, recordIdPolicy, new TreeMap<String, MetadataTransformation>(), recordXPath, new HashMap<String, String>());
        ...
        if (dataSourceContainer != null) {
            ...
            if (dataProviderParent != null) {
                if (!(dataSource instanceof DataSourceOai)) {
                    DataSource newDataSource = new DataSourceSruRecordUpdate(dataProviderParent, id, description, schema, namespace, metadataFormat, new IdGenerated(), new TreeMap<String, MetadataTransformation>());
    ...
    public DataSource updateDataSourceOai(String oldId, String id, String description, String schema, String namespace, String metadataFormat, String oaiSourceURL, String oaiSet, Map<String, MetadataTransformation> metadataTransformations, List<ExternalRestService> externalRestServices,
        ...
        if (dataSourceContainer != null) {
            ...
            if (new java.net.URL(oaiSourceURL).openConnection().getHeaderField(0) != null && FileUtilSecond.checkUrl(oaiSourceURL)) {
                ...
                if (dataProviderParent != null) {
                    if (!(dataSource instanceof DataSourceOai)) {
                        DataSource newDataSource = new DataSourceOai(dataProviderParent, id, description, schema, namespace, metadataFormat, oaiSourceURL, oaiSet, new IdProvided(), new TreeMap<String, MetadataTransformation>());
                        newDataSource.setAccessPoints(dataSource.getAccessPoints());
                        newDataSource.setStatus(dataSource.getStatus());
        ...
        if (dataSourceContainer != null) {
            ...
            if (dataProviderParent != null) {
                ...
                if (recordIdPolicy != null) {
                    ...
                    if (!(dataSource instanceof DataSourceDirectoryImporter)) {
                        DataSource newDataSource = new DataSourceDirectoryImporter(dataProviderParent, id, description, schema, namespace, metadataFormat, extractStrategy, retrieveStrategy, characterEncoding, sourcesDirPath, recordIdPolicy, new TreeMap<String, MetadataTransformation>(), recordXPath, new HashMap<String, String>());
                        newDataSource.setAccessPoints(dataSource.getAccessPoints());
                        newDataSource.setStatus(dataSource.getStatus());
    ...
    public String getDirPathFtp(String dataSourceId) {
        try {
            ...
            while (dataSource == null) {
                ...
                if (dataSource != null && ((DataSourceDirectoryImporter)dataSource).getRetrieveStrategy() instanceof DataSourceFtp) { return ((DataSourceDirectoryImporter)dataSource).getSourcesDirPath(); }
            }
        } catch (DocumentException e) {
            e.printStackTrace(); //To change body of catch statement use File | Settings | File Templates.
        } catch (IOException e) {
