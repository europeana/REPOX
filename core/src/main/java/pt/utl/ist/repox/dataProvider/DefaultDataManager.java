...
public class DefaultDataManager implements DataManager {
     ...
     */
    public DefaultDataManager(File dataProvidersFile, MetadataTransformationManager metadataTransformationManager, MetadataSchemaManager metadataSchemaManager, File repositoryPath, File oldTasksFile, DefaultRepoxConfiguration configuration) throws DocumentException, IOException, ParseException {
        super();
            ...
            for (Element currentDataProviderElement : (List<Element>)document.getRootElement().elements("provider")) {
                ...
                for (Element currentDataSourceElement : (List<Element>)currentDataProviderElement.elements("source")) {
                    ...
                    if (dataSource != null) {
                        ...
                        dataSourceContainers.put(dataSource.getId(), new DefaultDataSourceContainer(dataSource));
                    }
                }
        ...
        if (getDataSourceContainer(id) == null) {
            if (isIdValid(id)) {
                ...
                if (dataProvider != null) {
                    ...
                    DefaultDataSourceContainer DataSourceContainerDefault = new DefaultDataSourceContainer(newDataSource);
    ...
    public DataSource updateDataSourceSruRecordUpdate(String oldId, String id, String description, String schema, String namespace, String metadataFormat, Map<String, MetadataTransformation> metadataTransformations, List<ExternalRestService> externalRestServices, String marcFormat,
        ...
        if (dataSourceContainer != null) {
            ...
            if (dataProviderParent != null) {
                ...
                if (!id.equals(oldId)) {
                    DefaultDataSourceContainer dataSourceContainerDefault = new DefaultDataSourceContainer(dataSource);
