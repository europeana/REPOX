...
public class FileSystemOAICatalog extends AbstractCatalog {
    ...
    public FileSystemOAICatalog(Properties properties) {
        ...
        if (homeDir == null) throw new IllegalArgumentException("FileSystemOAICatalog." + "homeDir is missing from the properties file");
        if (debug) System.out.println("in FileSystemOAICatalog(): homeDir=" + homeDir);
     ...
     *         contains a set of Records objects. problem
     * @throws OAIInternalServerError
     *             signals an http status code 500 problem
     */
    @Override
