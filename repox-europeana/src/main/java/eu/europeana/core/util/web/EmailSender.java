...
public class EmailSender {
    ...
    public void sendEmail(final String toEmail, final String fromEmail, final String subject, final Map<String, Object> model, final String fileAttachment) throws TemplateException, IOException {
        MimeMessagePreparator preparator = new MimeMessagePreparator() {
            ...
            public void prepare(MimeMessage mimeMessage) throws MessagingException, IOException {
                ...
                */
                ...
                String fileAttachmentDecoded = URLDecoder.decode(fileAttachment, "ISO-8859-1");
                FileDataSource fileDataSource = new FileDataSource(fileAttachmentDecoded);
                attachmentPart.setDataHandler(new DataHandler(fileDataSource));
                attachmentPart.setFileName(new File(fileAttachment).getName());

                htmlContent.addBodyPart(htmlPage);
                htmlContent.addBodyPart(attachmentPart);
