...
//        }
    ...
    public Aggregator createAggregator(String aggregatorId, String name, String nameCode, String homepageUrl) throws InvalidArgumentsException, DocumentException, IOException, AlreadyExistsException {
        ...
        //Aggregator Id is specified and if not first generated by the nameCode and last from the Name
        ...
        //Check if aggregator already exists with the same Id, this check is for when the Id is provided and not generated
     ...
     */
    @Override
    public DataProvider updateDataProvider(String newAggregatorId, String providerId, String newProviderId, String name, String country, String countryCode, String description, String nameCode,
            String homepage,
                ...
                if (currentAggregator.getId().equals(aggregatorParent.getId())) {
                    ...
                    while (iteratorDataProvider.hasNext()) {
                        ...
                        if (currentDataProvider.getId().equals(dataProvider.getId())) {
                            ...
                            //Need to set it here cause else the remove will not happen correctly
...
//            if (isIdValid(id)) {
                ...
                if (dataProvider != null) {
                    ...
                    DataSource newDataSource = new SruRecordUpdateDataSource(dataProvider, newId, description, schema, namespace, metadataFormat,
...
//            if (isIdValid(id)) {
                ...
                if (dataProvider != null) {
                    ...
                    DataSource newDataSource = new DataSourceZ3950(dataProvider, newId, description, schema, namespace, harvestMethod, recordIdPolicy,
...
//        if (getDataSourceContainer(id) == null) {
            ...
            if (dataProvider != null) {
                ...
                if (recordIdPolicy != null) {
                    ...
                    DirectoryImporterDataSource newDataSource = new DirectoryImporterDataSource(dataProvider, newId, description, schema, namespace, metadataFormat,
...
//        }
    ...
    public DataSource updateDataSourceSruRecordUpdate(String oldId, String id, String description, String nameCode, String name, String exportPath,
            ...
            ObjectNotFoundException, InvalidArgumentsException, IncompatibleInstanceException, AlreadyExistsException {
...
//                throw new InvalidArgumentsException(id);
            ...
            if (dataProviderParent != null) {
                if (!(dataSource instanceof SruRecordUpdateDataSource)) {
                    DataSource newDataSource = new SruRecordUpdateDataSource(dataProviderParent, newId, description, schema, namespace, metadataFormat,
            ...
            if (new java.net.URL(newOaiSourceURL).openConnection().getHeaderField(0) != null && FileUtil.checkUrl(newOaiSourceURL)) {
                ...
                if (dataProviderParent != null) {
                    if (!(dataSource instanceof OaiDataSource)) {
                        DataSource newDataSource = new OaiDataSource(dataProviderParent, newId, description, schema, namespace, metadataFormat,
    ...
    public DataSource updateDataSourceZ3950Timestamp(String oldId, String id, String description, String nameCode, String name, String exportPath,
            ...
            throws DocumentException, IOException, ParseException, ObjectNotFoundException, IncompatibleInstanceException, InvalidArgumentsException, AlreadyExistsException {
        DefaultDataSourceContainer oldDataSourceContainer = (DefaultDataSourceContainer)getDataSourceContainer(oldId);
        if (oldDataSourceContainer != null) {
            DataSource dataSource = oldDataSourceContainer.getDataSource();
            if (!oldId.equals(id) && getDataSourceContainer(id) != null)
...
//                throw new InvalidArgumentsException(id);
            ...
            if (dataProviderParent != null) {
                ...
                if (!(dataSource instanceof DataSourceZ3950)) {
                    DataSource newDataSource = new DataSourceZ3950(dataProviderParent, newId, description, schema, namespace, harvestMethod,
    ...
    public DataSource updateDataSourceZ3950IdList(String oldId, String id, String description, String nameCode, String name, String exportPath,
            ...
            Map<String, MetadataTransformation> metadataTransformations, List<ExternalRestService> externalRestServices, boolean useLastIngestDate)
            throws DocumentException, IOException, ParseException, InvalidArgumentsException, ObjectNotFoundException, IncompatibleInstanceException, AlreadyExistsException {
        DefaultDataSourceContainer oldDataSourceContainer = (DefaultDataSourceContainer)getDataSourceContainer(oldId);
        if (oldDataSourceContainer != null) {
            DataSource dataSource = oldDataSourceContainer.getDataSource();
            if (!oldId.equals(id) && getDataSourceContainer(id) != null)
...
//                throw new InvalidArgumentsException(id);
    ...
    public DataSource updateDataSourceFtp(String oldId, String id, String description, String nameCode, String name, String exportPath,
            ...
            Map<String, String> namespaces, String recordXPath, String server, String user, String password, String ftpPath,
            Map<String, MetadataTransformation> metadataTransformations, List<ExternalRestService> externalRestServices, String marcFormat,
            boolean useLastIngestDate) throws DocumentException, IOException, InvalidArgumentsException, ObjectNotFoundException, AlreadyExistsException {
        DefaultDataSourceContainer oldDataSourceContainer = (DefaultDataSourceContainer)getDataSourceContainer(oldId);
        if (oldDataSourceContainer != null) {
            DataSource dataSource = oldDataSourceContainer.getDataSource();
            if (!oldId.equals(id) && getDataSourceContainer(id) != null)
    ...
    public DataSource updateDataSourceHttp(String oldId, String id, String description, String nameCode, String name, String exportPath,
            ...
            Map<String, String> namespaces, String recordXPath, String url, Map<String, MetadataTransformation> metadataTransformations,
            List<ExternalRestService> externalRestServices, String marcFormat, boolean useLastIngestDate) throws DocumentException, IOException,
            InvalidArgumentsException, ObjectNotFoundException, AlreadyExistsException {
        DefaultDataSourceContainer oldDataSourceContainer = (DefaultDataSourceContainer)getDataSourceContainer(oldId);
        if (oldDataSourceContainer != null) {
            DataSource dataSource = oldDataSourceContainer.getDataSource();
            if (!oldId.equals(id) && getDataSourceContainer(id) != null)
