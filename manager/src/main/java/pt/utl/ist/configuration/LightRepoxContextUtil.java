...
/**
 */
public class LightRepoxContextUtil implements RepoxContextUtil {
    private static final Logger        log                               = Logger.getLogger(LightRepoxContextUtil.class);
    ...
    private static LightRepoxManager repoxManager;

    @Override
    public LightRepoxManager getRepoxManager() {
        try {
            if (repoxManager == null) {
                ...
                repoxManager = new LightRepoxManager(configuration, DATA_PROVIDERS_FILENAME, STATISTICS_FILENAME, RECORD_COUNTS_FILENAME, SCHEDULED_TASKS_FILENAME, RECOVERABLE_TASKS_FILENAME, METADATA_TRANSFORMATIONS_FILENAME, OLD_TASKS_FILENAME, EXTERNAL_SERVICES_FILENAME, METADATA_SCHEMAS_FILENAME, TAGS_FILENAME);
            }
    ...
    @Override
    public LightRepoxManager getRepoxManagerTest() {
