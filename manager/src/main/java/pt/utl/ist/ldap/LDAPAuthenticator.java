...
//        Util.addLogEntry("RESULT = " + checkLDAPAuthentication(ldapURL, username, password), logger);
    ...
    public static boolean checkLDAPAuthentication(String ldapURL, String username, String password) {
        String ldapRootUser = ConfigSingleton.getRepoxContextUtil().getRepoxManager().getConfiguration().getLdapRootDN();
        ...
        //        properties.put( Context.SECURITY_PRINCIPAL, "cn=Simon Tzanakis,ou=office,ou=users,ou=tel,dc=theeuropeanlibrary,dc=org" );
