...
public class TagGroup extends Tag {
    ...
    /**
     * This constructor builds a TagGroup from the xpath virtual representation
     * of the TagGroup. The xpath of a TagGroup must be inside group() and must
     * have an initial prefix and final suffix, which may be empty strings.
     * After the initial prefix pairs of prefix (must exist, but may be an empty
     * string) and tag may be added.
     * 
     * <p>
     * Ex: group('initialPrefix',/oneTag,'prefix',/anotherTag/subNode,'')
     * </p>
     * 
