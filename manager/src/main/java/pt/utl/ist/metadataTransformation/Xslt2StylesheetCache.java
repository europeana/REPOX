...
/**
 * Caches all XSLT stylesheets as Templates. It reloads the templates when the
 * stylesheets' source file changes
 * 
...
public class Xslt2StylesheetCache {
    ...
    public Templates getTransformationTemplate(File stylesheetFile) throws TransformerException {
        ...
        synchronized (transformationFileHashMap) {
            ...
            if (transformationFile == null || transformationFile.isOutdated(stylesheetFile.lastModified()) || !transformationFile.subFilesUpToDate()) {
