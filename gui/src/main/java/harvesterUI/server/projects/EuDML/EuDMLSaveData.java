...
//        DataManagerEuDml dataManagerEuDml = (DataManagerEuDml)ConfigSingleton.getRepoxContextUtil().getRepoxManager().getDataManager();
//        if(update) {
//            DataProviderEuDML dataProvider = (DataProviderEuDML)dataManagerEuDml.getDataProvider(dataProviderUI.getId());
//            if(dataProvider != null) {
//                try {
//                    dataProvider = dataManagerEuDml.updateDataProvider(dataProvider.getId(),dataProviderUI.getName(),
//                            dataProviderUI.getCountry(), dataProviderUI.getDescription(),dataProviderUI.getEmail(),dataProviderUI.getIpAddress());
//                    dpId = dataProvider.getId();
//                    UserManagementServiceImpl.getInstance().addDPtoUser(username,dpId);
...
//        } else {
//            try {
//                DataProvider dataProvider = dataManagerEuDml.createDataProvider(dataProviderUI.getName(),
//                        dataProviderUI.getCountry(), dataProviderUI.getDescription(),dataProviderUI.getEmail(),dataProviderUI.getIpAddress());
...
//                                dataSourceUI.isStoreInYadda(),dataSourceUI.getMarcFormat(),dataSourceUI.isUseLastUpdateDate());
//                    } else if(type == DatasetType.SRU) {
//                        createdDataSource = repoxManagerEuDml.getDataManager().updateDataSourceSruRecordUpdate(originalDSset,
...
//                                    metadataTransformations,externalRestServices,dataSourceUI.isStoreInYadda(),
//                                    dataSourceUI.getMarcFormat(),dataSourceUI.isUseLastUpdateDate());
...
//                                    dataSourceUI.getRecordIdPolicy(), dataSourceUI.getIdXPath(),
//                                    namespaces, metadataTransformations,externalRestServices,dataSourceUI.isStoreInYadda(),
...
//                                    dataSourceUI.isUseLastUpdateDate());
//                        }
//                    }else if(type == DatasetType.YADDA) {
//                        createdDataSource = repoxManagerEuDml.getDataManager().updateDataSourceYadda(
//                                originalDSset,dataSourceUI.getDataSourceSet(), dataSourceUI.getDescription(),
//                                dataSourceUI.getSchema(), dataSourceUI.getMetadataNamespace(),
//                                dataSourceUI.getSourceMDFormat(), metadataTransformations,dataSourceUI.getYaddaCollection());
//                    }
//                    // External Services Run Type
//                    if(dataSourceUI.getExternalServicesRunType() != null && !dataSourceUI.getExternalServicesRunType().isEmpty())
...
//                                dataSourceUI.getSchema(), dataSourceUI.getMetadataNamespace(),
//                                dataSourceUI.getSourceMDFormat(), dataSourceUI.getOaiSource(),
//                                dataSourceUI.getOaiSet(), metadataTransformations,externalRestServices,dataSourceUI.isStoreInYadda(),dataSourceUI.getMarcFormat());
//                    }else if(type == DatasetType.SRU) {
//                        createdDataSource = repoxManagerEuDml.getDataManager().createDataSourceSruRecordUpdate(dataSourceUI.getDataSetParent().getId(),
//                                dataSourceUI.getDataSourceSet(), dataSourceUI.getDescription(),
//                                dataSourceUI.getSchema(), dataSourceUI.getMetadataNamespace(),
//                                dataSourceUI.getSourceMDFormat(), metadataTransformations,externalRestServices,
...
//                        }
//                    }else if(type == DatasetType.YADDA) {
//                        createdDataSource = repoxManagerEuDml.getDataManager().createDataSourceYadda(
//                                dataSourceUI.getDataSetParent().getId(),
//                                dataSourceUI.getDataSourceSet(), dataSourceUI.getDescription(),
//                                dataSourceUI.getSchema(), dataSourceUI.getMetadataNamespace(),
//                                dataSourceUI.getSourceMDFormat(),dataSourceUI.getExportDirectory(),
//                                metadataTransformations,dataSourceUI.getYaddaCollection());
//                    }
